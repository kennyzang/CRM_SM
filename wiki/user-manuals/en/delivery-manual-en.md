...
| Entry Point | Path |
|-------------|------|
| Standalone list | Left sidebar → **SALES ORDER** → **Delivery** | [Direct Link](http://172.18.114.231:8088/web/#/current/sys-modeling/app/km-ltc/listView/1jihg1ij4w5fw21vatw3g991pl1019hkj1w4/1jihf955sw5fw21tg4w163lk5o2mtdhg22w4?type=list&navId=1hvp21k7lw4vw6h64w37pp9dm27vj66f3cw1){: target="_blank" rel="noopener"} |
...
![Delivery List View](../../assets/delivery-list-001.png)
...
![Delivery Create Form](../../assets/delivery-create-001.png)
...
Customer Name is read-only, auto-derived from the linked Sales Order.
...
Every Delivery record **must be linked to a Sales Order** — it must trace back to a confirmed sale.
...
The person who physically handed over the goods, signed the delivery note, or confirmed the handover with the courier.
