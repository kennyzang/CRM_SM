...
| Total Excl Service Tax | Calculated | Qty x Unit Price |
...
|-------|-------|----------|--------|
| TC-027 | Invoice Application - Project vs Milestone Billing Comparison | P1 | Not Tested |
| TC-028 | Invoice Application - PDF Preview and Digital Signature | P2 | Not Tested |
