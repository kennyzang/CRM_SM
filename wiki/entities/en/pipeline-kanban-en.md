...
> Note: The DOCX description mentions 5 stages (Lead -> Opportunity -> PO -> SO -> Payment), but the actual UI shows **6 stages** with QUOTATION as a separate stage between OPPORTUNITY and PO.
...
|-------|-------|----------|--------|
| TC-032 | Pipeline Kanban - 6-Stage Summary Bar and Filter Interaction | P2 | Not Tested |

## Known Issues

1. **No dedicated page object yet**: Pipeline module is not yet implemented in the test suite.
2. **Test coverage**: 0%.
3. **Chinese UI labels**: Pagination footer shows Chinese labels -- these are defects (system language should be English).
