...
| Receivable Amount | — [V] | Auto | Calculated | Product Sum × Receivable % |
...
8. **Split payment support**: System auto-calculates Receivable Amount from percentage (e.g., 50% × 37,709.74 = 18,854.87) [V]
