...
Source: `pages/registry/opportunity.fields.ts`.
...
| File | Class |
|------|-------|
| `pages/OpportunityCreatePage.ts` | `OpportunityCreatePage` |
| `pages/registry/opportunity.fields.ts` | `OPPORTUNITY_SCHEMA` |
...
Chinese labels in the Opportunity UI (e.g., "商机名称" for "Opportunity Name") are **defects**.
